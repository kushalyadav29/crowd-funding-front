...
import heading from '../assets/ARTICLES.png'
...
function AllArticles() {
  ...
  return (
    <div className="articles">
      {/* <h1 className="all-article-h1">All Articles</h1> */}
      <img src={heading} className='head-article-img' alt='ARTICLES'/>
      <div className="article-container">
        {articlesData.map((article, index) => (
          <div className="article" key={index}>
            ...
            <span className="article-trees-planted">
              Trees Planted: {article.treesPlanted}
            </span>
            <span className="article-image">
              <img src={article.imageSrc} alt={article.heading} />
            </span>
